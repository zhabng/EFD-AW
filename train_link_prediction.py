...
from models.EFD_AW import EFD_AW
...
from DataLoader import get_idx_data_loader, get_link_prediction_data
...
if __name__ == "__main__":
    ...
    # initialize negative samp·lers, set seeds for validation and testing so negatives are the same across different runs
    ...
    for run in range(args.num_runs):
        ...
        # create model
        if args.model_name == 'EFD_AW':
           dynamic_backbone = EFD_AW(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler,
